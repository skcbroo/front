...
export default function DetalhesCredito() {
  ...
  <div className="flex justify-center items-center min-h-[80vh] px-4">
    <div className="bg-white text-black p-8 rounded-2xl shadow-xl w-full max-w-xl select-none cursor-default space-y-4">
      ...
      <div className="space-y-1">
        <p>
          <strong>📦 Cotas totais:</strong> {totalCotas}
        </p>
        <p>
          <strong>{cotasDisponiveis > 0 ? '🟢' : '🔴'} Cotas disponíveis:</strong> {cotasDisponiveis}
        </p>
        <p>
          <strong>💵 Preço por cota:</strong>{' '}
